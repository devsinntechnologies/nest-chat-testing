...
const Page: React.FC = () => {
  ...
  const [resendVerificationEmail, { isLoading: resendVerificationEmailLoading }] =
  useResendVerificationEmailMutation();
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedData = sessionStorage.getItem("userVerify");
      ...
      verifyEmail({ email, otp })
        .then((response) => {
          if (response?.data?.success) {
            sessionStorage.removeItem("userVerify");
      ...
      <form className="space-y-8" onSubmit={handleSubmit}>
        ...
        <div className="w-full space-y-3">
          <Button
            ...
            disabled={verifyingEmail || resendVerificationEmailLoading}
          >
            {verifyingEmail ? (
